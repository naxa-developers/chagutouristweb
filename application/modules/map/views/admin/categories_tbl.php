                        ...
                        <td>
                          ...
                          <?php foreach($v as $key => $value) { ?>
                            ...
                            <?php  } ?>
                              ...
                              <td><a href="<?php echo base_url(FOLDER_ADMIN)?>/map/add_all_details?tbl=<?php echo base64_encode($v['sub_categories']);?>"><button type="submit" class="btn-sm btn-primary">Add Information</button></a></td>
