           ...
           Location Category
            <form role="form"  method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group position-center">
                  ...
                  <label for="name">Location Category Name:</label>
                  <input type="text" name="name" class="form-control" id="name" value="<?php echo !empty($drrdataeditdata[0]['name'])?$drrdataeditdata[0]['name']:'' ?>" placeholder="ENTER LOCATION CATEGORY NAME">
            ...
            <?php }else{ ?>
              <table class="table table-hover" id="tb3">
                  ...
                  <tr>
                    ...
                    <?php }  ?>
                      <td>
                        <a href="<?php echo base_url(FOLDER_ADMIN)?>/location/add_publication_category?id=<?php echo base64_encode($v['id']);?>"><?php echo $this->lang->line('edit'); ?></a> /
                        <a onclick="return confirm('Are you sure you want to delete?')" href="<?php echo base_url(FOLDER_ADMIN)?>/location/delete_publication?id=<?php echo  $v['id'];?>"><?php echo $this->lang->line('delete'); ?></a></td>
                  </tr>
                <?php  }?>
                  </tbody>
              </table>
